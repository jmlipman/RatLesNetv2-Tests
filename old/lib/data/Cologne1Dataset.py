...
class Cologne1Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, split, loss=None, dev=None, seg="IAM"):
        ...
        if pc_name == "taito-gpu.csc.fi":
            ...
            # LOCAL
            self.PATH = "/media/miguelv/HD1/dataset_mulder/Cologne-Set-1/"
        elif pc_name == "nmrcs3":
            # NMR-CS3
            raise Exception("It should not be here")
        ...
        studies = ["3months_old/18h", "3months_old/D4"]
        ...
        for i, study in enumerate(studies):
            ...
            if split == "train":
                if i == 0:
                    ...
                    self.list += self.lesion[:1]

            elif split == "validation":
                if i == 0:
                    self.list += self.lesion[3:4]
                else:
                    self.list += self.lesion[1:2]
            else:
                if i == 0:
                    self.list += self.lesion[4:]
                else:
