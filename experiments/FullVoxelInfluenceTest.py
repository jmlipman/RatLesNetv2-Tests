...
ex = Experiment("FULLVoxelInfluenceTest")

@ex.main
def main(config, Model, data, base_path, _run, start):
    ...
    firstRange = [10, 10] #I know it's not going to be more than 20
    secondRange = [10, 10]

    for ind in range(start, 15000):
